...
#define Mix_PlayChannel(channel,chunk,loops) Mix_PlayChannelTimed(channel,chunk,loops,-1)
	...
	extern DECLSPEC int SDLCALL Mix_PlayChannelTimed(int channel, Mix_Chunk* chunk, int loops, int render_cycles);
...
#define Mix_FadeInChannel(channel,chunk,loops,ms) Mix_FadeInChannelTimed(channel,chunk,loops,ms,-1)
	extern DECLSPEC int SDLCALL Mix_FadeInChannelTimed(int channel, Mix_Chunk* chunk, int loops, int ms, int render_cycles);
	...
	*/
	extern DECLSPEC int SDLCALL Mix_ExpireChannel(int channel, int render_cycles);
